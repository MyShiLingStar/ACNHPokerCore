...
namespace ACNHPokerCore
{
    public static class Teleport
    {
        ...
        private static readonly string offset = "[[[[main+4BFAE30]+18]+178]+D0]+DA"; //"[[[[main+4BF9E30]+18]+178]+D0]+DA";//"[[[[main+4627088]+18]+178]+D0]+DA"; //"[[[[main+460ED68]+18]+178]+D0]+DA"; //"[[[[main+3A33980]+18]+178]+D0]+DA"; //"[[[[main+3A32980]+18]+178]+D0]+DA"; //"[[[[main+3A08B40]+18]+178]+D0]+DA"; //"[[[[main+39DC030]+18]+178]+D0]+DA";//"[[[[main+398C380]+18]+178]+D0]+DA";//"[[[[main+396F5A0]+18]+178]+D0]+DA";
